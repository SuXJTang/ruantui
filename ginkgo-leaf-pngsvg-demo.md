...
<head>
  ...
  <style>
    ...
    /* 季节背景样式 */
    body.spring {
      background: linear-gradient(135deg, #e4f5e5 0%, #c3e8d8 100%);
    }
    
    body.autumn {
      background: linear-gradient(135deg, #f7edd0 0%, #f2d0a4 100%);
    }
    
    body.winter {
      background: linear-gradient(135deg, #f0f4f8 0%, #dfe7f2 100%);
    }
